        ...
        <div className="w-full max-w-[440px] bg-white border border-slate-200 rounded-lg p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm font-medium text-slate-600 hover:text-slate-900 underline underline-offset-2">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="text-center text-sm text-slate-600">
            <p className="text-slate-500">
              ...
              <Link to="/register" className="text-slate-900 font-bold hover:underline">Sign up</Link>
            </p>
          </div>
        </div>
      </div>
