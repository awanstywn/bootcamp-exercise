...
- **SEO & PWA:** React Helmet Async, dynamic XML Sitemap parsing, Vite PWA
- **Performance:** Cloudinary CDN integration (`f_auto`, `q_auto`), lazy loading
...
3. Start the Vite dev server wrapper:
   ```bash
   npm run dev
   ```

**Docker Containerization:**
The frontend client is designed to be built together with the backend into a single Docker image from the root directory. To run it inside Docker, follow the instructions in the root `README.md`.
