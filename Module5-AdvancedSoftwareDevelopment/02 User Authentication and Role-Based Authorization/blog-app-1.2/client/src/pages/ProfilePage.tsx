...
export default function ProfilePage() {
  ...
  const [requestStatus, setRequestStatus] = useState<{status: string} | null>(null);
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 space-y-2">
                      <input type="url" value={formData.avatarUrl} onChange={e => setFormData({...formData, avatarUrl: e.target.value})} placeholder="Paste image URL here..." className="w-full border border-slate-200 rounded px-3 py-2 outline-none focus:border-slate-900 text-sm" />
                    </div>
                  </div>
                </div>
                <div>
