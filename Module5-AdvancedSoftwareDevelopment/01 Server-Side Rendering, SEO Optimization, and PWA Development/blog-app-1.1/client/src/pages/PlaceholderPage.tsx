...
export default function PlaceholderPage() {
  ...
  const titleName =
    location.pathname.split('/').filter(Boolean).pop()?.replace(/-/g, ' ').toUpperCase() || 'PAGE';
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center text-center p-8">
      ...
      <p className="text-slate-500 max-w-md">
        The <span className="font-medium text-slate-900">{titleName}</span> page is currently under
