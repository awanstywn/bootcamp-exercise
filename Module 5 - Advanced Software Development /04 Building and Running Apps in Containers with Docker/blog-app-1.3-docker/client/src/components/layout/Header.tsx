    ...
    <header className="bg-white border-b border-surface-200 py-4 px-8 flex items-center justify-between">
      ...
      <nav className="hidden md:flex gap-8 text-sm font-medium text-slate-600 items-center">
        ...
        <div className="relative group cursor-pointer py-4 -my-4">
          <div className="flex items-center gap-1 hover:text-slate-900 pb-1 border-b-2 border-transparent group-hover:border-slate-300">
            Categories
            <svg
      ...
      <div className="flex gap-4 items-center">
        ...
        {isLoading ? (
          <div className="w-32 h-8 bg-slate-100 animate-pulse rounded-full hidden sm:block"></div>
        ) : isAuthenticated ? (
          <>
            <Link
              to="/dashboard"
