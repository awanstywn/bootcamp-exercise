...
export default function CategoriesIndexPage() {
  ...
  const sortedCategories = [...categories].sort(
    (a, b) => (b._count?.posts || 0) - (a._count?.posts || 0),
  );
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 min-h-screen">
      ...
      <div className="mb-12 pb-8 border-b border-slate-200 text-center max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold font-serif text-slate-900 mb-4">Explore Categories</h1>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {displayedCategories.map((category) => (
            ...
            >
              <div>
                <h2 className="text-xl font-bold font-serif text-slate-900 mb-2 group-hover:text-slate-700 transition-colors">
                  {category.name}
                </h2>
