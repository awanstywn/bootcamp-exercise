    ...
    <div className="max-w-4xl mx-auto px-6 py-16 min-h-screen">
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <section className="mb-10 space-y-4 text-slate-700">
          ...
          <p>
            By accessing and using BlogApp, you accept and agree to be bound by the terms and
        ...
        <section className="mb-10 space-y-4 text-slate-700">
          ...
          <p>
            ...
            functionality are and will remain the exclusive property of BlogApp and its licensors.
          </p>
        </section>
      </div>
    </div>
