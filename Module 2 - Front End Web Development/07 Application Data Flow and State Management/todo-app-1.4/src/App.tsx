...
import { Routes, Route, Navigate } from "react-router-dom"; // ← NEW: routing components
import useAuthStore from "./store/useAuthStore";              // ← NEW: auth store
...
import SignIn from "./page/SignIn";                            // ← NEW: Sign In page
...
// ── TodoPage: The existing todo app layout (extracted into its own component) ──
function TodoPage() {
